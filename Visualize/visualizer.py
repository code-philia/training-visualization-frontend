...
class Visualizer(VisualizerAbstractClass):
    ...
    def savefig(self, epoch, embedding, path="vis"):
        '''
    ...
    def save_scale_bgimg(self, epoch, resolution):
        ...
        fig, ax = plt.subplots(1, 1, figsize=(resolution*px, resolution*px))
        ax.set_axis_off()
    ...
    def get_standard_classes_color(self):
        ...
        mesh_classes = np.arange(len(self.classes)+2)
        # apply more color
        color_map = plt.cm.get_cmap('tab20', self.class_num+2)
